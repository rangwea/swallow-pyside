...
"""
Thanks https://github.com/Erimus-Koo/qCloud-COS-Sync
    ...
    while not end:
        ...
        while times < 100:
            ...
            try:
                ...
                time.sleep(3)
            if times == 100:
                print(f'===Error===: {subFolder} info load failed')
                res = {}
    ...
    def upload(self, localFile, maxAge=None):
        ...
        while times < self.cfg['retry_limit']:
            ...
            try:
                ...
                logging.info(f'Upload | {localFile}')
                break
            except CosServiceError as e:
                logging.info(repr(e))
                pass
        else:
            logging.info(f'Error: Upload failed! | {localFile}')
            ...
            while times < self.cfg['retry_limit']:
                ...
                try:
                    ...
                    if 'Error' in res:
                        ...
                        raise
                    logging.info(f'Delete | {len(once)} files')
                    logging.info(formatJSON(once))
                    break
                except Exception as e:
                    logging.info(f'Delete tried: {times} times\n{repr(e)}')
                    pass
            else:
                logging.info(f'Error: delete failed!\n{formatJSON(once)}')
...
if __name__ == '__main__':
    ...
    if os.name == 'nt':
        ...
        root = '/Users/OneDrive/yourRoot'  # MAC
